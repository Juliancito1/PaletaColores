    ...
    return (
        <section>
            ...
            <aside className='d-flex flex-column flex-md-row align-items-center'>
                <div className='ms-md-5 border border-2 border-dark' style={{backgroundColor: `${color}`,padding: '70px'}}></div>
                <Form className='mt-4 ms-md-5 mt-lg-0 w-50' onSubmit={handleSubmit} >
